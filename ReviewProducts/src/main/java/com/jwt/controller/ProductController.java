...
public class ProductController {
	...
	@RequestMapping(value = "/continuedContent" , method = RequestMethod.GET)
	public ModelAndView scroller(HttpServletRequest request) throws IOException {
		randomProducts = productService.getRandom3Products(randomstart,randomend);
		int next = Integer.parseInt(request.getParameter("count"));
	...
	public ModelAndView listBooksProduct(HttpServletRequest request) throws IOException {
		...
		CategoryProducts = productService.getByCategory(Category);
		ModelAndView model = new ModelAndView("/");
